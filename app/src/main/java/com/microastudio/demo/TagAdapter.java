...
public abstract class TagAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> implements View.OnClickListener {
    ...
    public abstract void afterBindViewHolder(VH holder, int position);
    ...
    public void onClick(View v) {
        ...
        if (selectMode == SelectMode.CLICK) {
            ...
            if (maxSelectedCount <= 0
                    //选择不受限制
                    || multiSelected.size() < maxSelectedCount) {
                // 选择个数需要小于最大可选数
     ...
     * 设置默认选中项，一个或多个
     *
     * @param itemPositions itemPositions
     */
    ...
    public enum SelectMode {
        CLICK, MULTI_SELECT, SINGLE_SELECT
    }
